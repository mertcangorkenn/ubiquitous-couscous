...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void loadInterstitialAd() {
        ...
        interstitialAd.setListener(new MyMaxAdListener());
    ...
    private class MyMaxAdListener implements MaxAdListener {
        ...
        public void onAdLoadFailed(String adUnitId, MaxError error) {
            if (adUnitId.equals(getString(R.string.interstitial_ad_unit_id))) {
                Log.d(TAG, "Interstitial ad failed to load: " + error.getMessage());
            } else if (adUnitId.equals(getString(R.string.banner_ad_unit_id))) {
                Log.d(TAG, "Banner ad failed to load: " + error.getMessage());
            }
        }
        ...
        public void onAdDisplayFailed(MaxAd ad, MaxError error) {
            if (ad instanceof MaxInterstitialAd) {
                Log.d(TAG, "Interstitial ad failed to display: " + error.getMessage());
                interstitialAd.loadAd();
            } else if (ad instanceof MaxAdView) {
                Log.d(TAG, "Banner ad failed to display: " + error.getMessage());
            }
        }
    }
